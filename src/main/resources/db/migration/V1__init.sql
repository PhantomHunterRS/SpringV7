...
insert into PRODUCT (title, cost) values ('Cake - Cake Sheet Macaroon', 4044.06);
insert into PRODUCT (title, cost) values ('Wine - Riesling Alsace Ac 2001', 3137.46);
insert into PRODUCT (title, cost) values ('Juice - Orange, 341 Ml', 1750.15);
...
insert into PRODUCT (title, cost) values ('Cheese - Havarti, Salsa', 2729.550);
...
insert into PRODUCT (title, cost) values ('Extract - Raspberry', 2309.59);
insert into PRODUCT (title, cost) values ('Savory', 4964.36);
insert into PRODUCT (title, cost) values ('Fireball Whisky', 4986.94);
insert into PRODUCT (title, cost) values ('Dates', 2766.19);
...
insert into PRODUCT (title, cost) values ('Glass - Juice Clear 5oz 55005', 155.34);
...
insert into buyer(name) values ('Martin');
insert into buyer(name) values ('Stuart');
insert into buyer(name) values ('Rikki');
insert into buyer(name) values ('Trash');
insert into buyer(name) values ('Jimmy');
insert into buyer(name) values ('Steven');
insert into buyer(name) values ('Mammy');
